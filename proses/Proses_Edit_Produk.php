...
$rnpquery = mysql_query ("UPDATE produk SET Nama_Produk='$skynama', Gambar_Produk='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Produk='$skyid' ");
