...
$rnpquerysave = mysql_query("INSERT INTO muslim (Gambar_Muslim,Nama_Muslim,Ukuran,Warna,Stok,Harga,Supplier) VALUES ('$gambar','$nama','$ukuran','$warna','$stock','$harga','$akun')");
    if($rnpquerysave){
    if($rnpquerymove){
