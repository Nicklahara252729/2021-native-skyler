...
$rnpquerysave = mysql_query("INSERT INTO tshirt (Gambar_Tshirt,Nama_Tshirt,Ukuran,Warna,Stok,Harga,Supplier) VALUES ('$gambar','$nama','$ukuran','$warna','$stock','$harga','$akun')");
    if($rnpquerysave){
    if($rnpquerymove){
