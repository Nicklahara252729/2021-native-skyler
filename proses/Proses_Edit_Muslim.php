...
$rnpquery = mysql_query ("UPDATE muslim SET Nama_Muslim='$skynama', Gambar_Muslim='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Muslim='$skyid' ")or die (mysql_error());
