...
$rnpquery = mysql_query ("UPDATE baby SET Nama_Baby='$skynama', Gambar_Baby='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Baby='$skyid' ")or die (mysql_error());
