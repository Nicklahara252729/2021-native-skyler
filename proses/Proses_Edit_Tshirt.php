...
$rnpquery = mysql_query ("UPDATE tshirt SET Nama_Tshirt='$skynama', Gambar_Tshirt='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Tshirt='$skyid' ");
