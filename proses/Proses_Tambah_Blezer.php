...
$rnpquerysave = mysql_query("INSERT INTO blezer (Gambar_Blezer,Nama_Blezer,Ukuran,Warna,Stok,Harga,Supplier) VALUES ('$gambar','$nama','$ukuran','$warna','$stock','$harga','$akun')");
    if($rnpquerysave){
    if($rnpquerymove){
