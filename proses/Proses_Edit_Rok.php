...
$rnpquery = mysql_query ("UPDATE rok SET Nama_Rok='$skynama', Gambar_Rok='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Rok='$skyid' ")or die (mysql_error());
