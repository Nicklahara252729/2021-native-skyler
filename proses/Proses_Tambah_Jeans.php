...
$rnpquerysave = mysql_query("INSERT INTO produk (Nama_Produk,Gambar_Produk,Kategori,Ukuran,Warna,Stok,Harga,Supplier) VALUES ('$nama','$gambar','Jeans','$ukuran','$warna','$stock','$harga','$akun')");
    if($rnpquerysave){
    if($rnpquerymove){
