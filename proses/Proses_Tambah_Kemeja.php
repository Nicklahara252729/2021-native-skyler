...
$rnpquerysave = mysql_query("INSERT INTO kemeja (Gambar_Kemeja,Nama_Kemeja,Ukuran,Warna,Stok,Harga,Supplier) VALUES ('$gambar','$nama','$ukuran','$warna','$stock','$harga','$akun')");
    if($rnpquerysave){
    if($rnpquerymove){
