...
$rnpquery = mysql_query ("UPDATE user_supplier SET Nama_Lengkap='$skynama', Alamat='$skyalamat', Kode_Pos='$skykodepos', Email='$skyemail', Username='$skyusername', Password='$skypassword' WHERE ID='$skyid' ")or die (mysql_error());
