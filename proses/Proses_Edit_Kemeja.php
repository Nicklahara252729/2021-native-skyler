...
$rnpquery = mysql_query ("UPDATE kemeja SET Nama_Kemeja='$skynama', Gambar_Kemeja='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Kemeja='$skyid' ")or die (mysql_error());
