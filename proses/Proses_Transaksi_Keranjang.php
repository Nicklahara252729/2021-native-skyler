...
$skyid = $_GET['ID'];
$skysemua = count($skyproduk);
for ($i=0; $i < $skysemua; $i++){
$skyquery = mysql_query("INSERT INTO transaksi (Nama_Produk,Jumlah,Harga,Total,Nama,Alamat,Kode_Pos,Email,No_HP,Pembeli,Supplier,Status) VALUES ('$skyproduk['$i']','$skyjumlah['$i']','$skyharga['$i']','$skytotal['$i']','$skynama['$i']','$skyalamat['$i']','$skypos['$i']','$skyemail['$i']','$skyhp['$i']','$skypembeli['$i']','$skysupplier['$i']','Belum Terkirim')");}
