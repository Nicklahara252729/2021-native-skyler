...
$rnpquery = mysql_query ("UPDATE blezer SET Nama_Blezer='$skynama', Gambar_Blezer='$gambar', Ukuran='$skyukuran', Warna='$skywarna', Stok='$skystock', Harga='$skyharga'  WHERE ID_Blezer='$skyid' ")or die (mysql_error());
