...
$skyquery = mysql_query("SELECT * FROM user_supplier");
$rnpdata = mysql_fetch_array($skyquery);
if (isset ($_SESSION['user_supplier']) && ($rnpdata['Jenis'] == 'Pembeli')) {
?>
<?php 
include "../proses/koneksi.php";
$skyid = $_GET['ID'];
$skyquery = mysql_query("SELECT * FROM produk WHERE ID_Produk='$skyid'");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pesanan">
            Nama Produk : <?php echo $skyrow['Nama_Produk'] ;?><br>
            Gambar Barang : 
            <img src="../uploaded/<?php echo $skyrow['Gambar_Produk'] ;?>" width="200px" height="200px">
            <br>
            Jumlah Pembelian : <input type="text" name=""><br>
            Harga Satuan : <?php echo "Rp.";echo number_format($skyrow['Harga']) ;?> <br>
            Nama : <input type="text" name=""><br>
            Alamat Lengkap : <input type="text" name=""><br>
            Kode Pos : <input type="text" name=""><br>
            Email : <input type="text" name=""><br>
            No HP Yg Bisa Dihubungi : <input type="text" name=""><br>
            Jumlah Total : <br>
...
<h2>Sorry</h2>
<p>
Anda Tidak Berhak Mengakses Halaman Ini.<br>
Silahkan Menggunakan Akun Pembeli Untuk Memesan Barang.<br>
<a href="Form_Supplier.php">Back</a>
</p>
<?php
}
?>