...
<?php 
    ...
    $skyquery = mysql_query("SELECT * from cart WHERE ID_Session='$sesid' LIMIT 5");
...
?>
            ...
            <?php echo "<a href='../proses/Proses_Hapus_Keranjang_Konsumen.php?ID=".$skyrow['ID_Keranjang']."'> Hapus";?><?php echo "</a>";?> </td>
            </tr>
<?php
$j++; }
?>
            ...
            <a href="Form_Pemesanan_Keranjang_Konsumen.php">Selesai</a>
            </div>
</div>
