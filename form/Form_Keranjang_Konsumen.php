...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-keranjang">
            Form Keranjang<br><br>
            <table style="border:3px solid black;text-align:center;">
            <tr>
            <th style="padding-left:10px;">No</td>
            <th style="padding-left:10px;">Nama Barang</th>
            <th style="padding-left:10px;">Harga</th>
            <th style="padding-left:10px;">Jumlah</td>
            <th style="padding-left:10px;">Keterangan</td>
            </tr>
<?php 
    $sesid = session_id();
    ...
    $jumlah = mysql_num_rows($skyquery);
    if ($jumlah < 1){
...
?>
            <tr>
            <td style="padding-left:10px;"><?php echo $j+1 ;?></td>
                <td style="padding-left:10px;"><?php echo $skyrow['Nama_Barang'] ;?></td>
                <td style="padding-left:10px;"><?php echo $skyrow['Harga'] ;?></td>
            <td style="padding-left:10px;"><?php echo $skyrow['Jumlah'] ;?></td>
            <td style="padding-left:10px;">
            <?php echo "<a href='../proses/Proses_Hapus_Keranjang.php?ID=".$skyrow['ID_Keranjang']."'> Hapus";?><?php echo "</a>";?> </td>
            </tr>
<?php
$j++; }
?>
            </table><br>
            <a href="Form_Konsumen.php">Belanja Lagi</a><br>
            <a href="Form_Pemesanan.php">Selesai</a>
            </div>
</div>
