...
$id = $_GET['IDR'];
$skyquery = mysql_query("SELECT * FROM rok WHERE ID_Rok='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Rok.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Rok'] ;?>" style="visibility:hidden;"><br>
            Nama Rok <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Rok'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Rok'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
