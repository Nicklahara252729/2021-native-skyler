    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Produk.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Produk'] ;?>" style="visibility:hidden;"><br>
            Nama Produk <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Produk'] ;?>" required><br>
            Gambar Produk <img src="../uploaded/<?php echo $skyrow['Gambar_Produk'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
