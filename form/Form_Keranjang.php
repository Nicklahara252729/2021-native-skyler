...
$skyquery = mysql_query("SELECT * FROM produk");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<?php 
    ...
    $skyquery = mysql_query("SELECT * from cart,produk WHERE ID_Session='$sesid' AND cart.ID_Produk=produk.ID_Produk");
...
?>
            ...
            <td style="padding-left:10px;"><?php echo $j+1 ;?></td>
                <td style="padding-left:10px;"><?php echo $skyrow['Nama_Produk'] ;?></td>
                <td style="padding-left:10px;"><?php echo $skyrow['Harga'] ;?></td>
            <td style="padding-left:10px;"><?php echo $skyrow['Jumlah'] ;?></td>
            <td style="padding-left:10px;">
            <?php echo "<a href='../proses/Proses_Hapus_Keranjang.php?ID=".$skyrow['ID_Produk']."'> Hapus";?><?php echo "</a>";?> </td>
            </tr>
<?php
$j++; }
?>
            ...
            <a href="Form_Pemesanan_Supplier.php">Selesai</a><br>
            <font size="4" style="font-weight:bold;color:red;">Catatan => Hapus Semua Barang di Keranjang Setelah Berbelanja</font>
            </div>
</div>
