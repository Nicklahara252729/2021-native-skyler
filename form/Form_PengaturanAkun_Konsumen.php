...
$skyquery = mysql_query("SELECT * FROM user_konsumen WHERE Username='$akun'");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            Nama Lengkap = <?php echo $skyrow['Nama_Konsumen'] ;?><br>
            Jenis Kelamin = <?php echo $skyrow['Jenis_Kelamin']; ?><br>
            Kota = <?php echo $skyrow['Kota'] ;?><br>
            Alamat = <?php echo $skyrow['Alamat'] ;?><br>  
            Email = <?php echo $skyrow['Email'] ;?><br>
            Username = <font name="ID"><?php echo $skyrow['Username'] ;?></font><br>
            Password = <?php echo $skyrow['Password'] ;?><br>
            <?php echo "<a href='Form_Edit_AkunKonsumen.php?ID=".$skyrow['ID_Konsumen']."'> Edit Info Akun";?><br>
