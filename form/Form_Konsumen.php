...
$skyquerybaby = mysql_query("SELECT * FROM baby");
$skyqueryblezer = mysql_query("SELECT * FROM blezer");
$skyquerydress = mysql_query("SELECT * FROM dress");
$skyqueryjeans = mysql_query("SELECT * FROM jeans");
$skyquerykemeja = mysql_query("SELECT * FROM kemeja");
$skyquerymuslim = mysql_query("SELECT * FROM muslim");
$skyqueryrok = mysql_query("SELECT * FROM rok");
$skyquerytshirt = mysql_query("SELECT * FROM tshirt");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="content">
            ...
            <?php echo "<a href='Form_DetailTshirt_Highlight_Konsumen.php?IDT=".$skyrowtshirt['ID_Tshirt']."'>";?>
            ...
            <?php echo "<a href='Form_DetailDress_Highlight_Konsumen.php?IDD=".$skyrowdress['ID_Dress']."'>";?>
            ...
            <?php echo "<a href='Form_DetailRok_Highlight_Konsumen.php?IDR=".$skyrowrok['ID_Rok']."'>";?>
            ...
            <?php echo "<a href='Form_DetailJeans_Highlight_Konsumen.php?IDJ=".$skyrowjeans['ID_Jeans']."'>";?>
            ...
            <?php echo "<a href='Form_DetailBaby_Highlight_Konsumen.php?IDB=".$skyrowbaby['ID_Baby']."'>";?>
            ...
            <?php echo "<a href='Form_DetailMuslim_Highlight_Konsumen.php?IDM=".$skyrowmuslim['ID_Muslim']."'>";?>
            ...
            <?php echo "<a href='Form_DetailKemeja_Highlight_Konsumen.php?IDK=".$skyrowkemeja['ID_Kemeja']."'>";?>
            ...
            <?php echo "<a href='Form_DetailBlezer_Highlight_Konsumen.php?IDBL=".$skyrowblezer['ID_Blezer']."'>";?>
