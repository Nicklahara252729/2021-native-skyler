            ...
            <div class="in-content" id="main">
                <div class="isi-content" id="content-tshirt">
                    ...
                    <div class="show" id="show" onclick="hover()">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowtshirt['ID_Produk']; ?>&&sup=<?php echo $skyrowtshirt['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowtshirt['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-dress">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowdress['ID_Produk']; ?>&&sup=<?php echo $skyrowdress['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowdress['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-rok">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowrok['ID_Produk']; ?>&&sup=<?php echo $skyrowrok['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowrok['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-jeans">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowjeans['ID_Produk']; ?>&&sup=<?php echo $skyrowjeans['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowjeans['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-baby">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowbaby['ID_Produk']; ?>&&sup=<?php echo $skyrowbaby['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowbaby['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-muslim">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowmuslim['ID_Produk']; ?>&&sup=<?php echo $skyrowmuslim['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowmuslim['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-kemeja">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowkemeja['ID_Produk']; ?>&&sup=<?php echo $skyrowkemeja['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowkemeja['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
                ...
                <div class="isi-content" id="content-blezer">
                    ...
                    <div class="show">
                        ...
                        <div class="keterangan" id="ket">
                            <a href="Form_Detail_Produk_Konsumen.php?ID=<?php echo $skyrowblezer['ID_Produk']; ?>&&sup=<?php echo $skyrowblezer['Supplier']; ?>"><button type="button">Detail Barang</button></a>
                            <a href="../proses/Proses_Input_Keranjang_Konsumen.php?ID=<?php echo $skyrowblezer['ID_Produk'];?>"><button type="button">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                </button></a>
                        </div>
                    </div>
