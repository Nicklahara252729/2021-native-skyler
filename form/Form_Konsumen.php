...
$skyquerybaby = mysql_query("SELECT * FROM produk WHERE Kategori='Baby'");
$skyqueryblezer = mysql_query("SELECT * FROM produk WHERE Kategori='Blezer'");
$skyquerydress = mysql_query("SELECT * FROM produk WHERE Kategori='Dress'");
$skyqueryjeans = mysql_query("SELECT * FROM produk WHERE Kategori='Jeans'");
$skyquerykemeja = mysql_query("SELECT * FROM produk WHERE Kategori='Kemeja'");
$skyquerymuslim = mysql_query("SELECT * FROM produk WHERE Kategori='Muslim'");
$skyqueryrok = mysql_query("SELECT * FROM produk WHERE Kategori='Rok'");
$skyquerytshirt = mysql_query("SELECT * FROM produk WHERE Kategori='Tshirt'");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div class="bawah">
            <div class="sub-bawah">
                <ul>
                    ...
                    include "../proses/koneksi.php";
                    $skyses = session_id();
                    $skyqueryj = mysql_query("SELECT * FROM cart WHERE ID_Session='$skyses'");
