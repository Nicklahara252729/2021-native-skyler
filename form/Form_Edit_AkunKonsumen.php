...
$id = $_GET['ID'];
$skyquery = mysql_query("SELECT * FROM user_konsumen WHERE ID_Konsumen='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_AkunKonsumen.php" method="post" enctype="multipart/form-data">
            Edit Info Akun<br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Konsumen'] ;?>" style="visibility:hidden;"><br>
            Nama Lengkap = <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Konsumen'] ;?>"><br>
            Jenis Kelamin = <input type="text" name="Jenkel" value="<?php echo $skyrow['Jenis_Kelamin'] ;?>"><br>
            Kota = <input type="text" name="Kota" value="<?php echo $skyrow['Kota'] ;?>"><br>
            Alamat = <input type="text" name="Alamat" value="<?php echo $skyrow['Alamat'] ;?>"><br>
            Email = <input type="text" name="Email" value="<?php echo $skyrow['Email'] ;?>"><br>
            Username = <input type="text" name="Username" value="<?php echo $skyrow['Username'] ;?>"><br>
            Password = <input type="password" name="Password" value="<?php echo $skyrow['Password'] ;?>"><br>
            <input type="submit" value="Edit Info" name="submit">
            </form><br>
            <a href="Form_PengaturanAkun_Konsumen.php">Kembali</a>
</div>
        <footer>
