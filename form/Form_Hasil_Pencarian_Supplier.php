...
$skyquerybaby = mysql_query("SELECT * FROM baby WHERE Nama_Baby LIKE '%$skypencarian%' ");
$skyqueryblezer = mysql_query("SELECT * FROM blezer WHERE Nama_Blezer LIKE '%$skypencarian%' ");
$skyquerydress = mysql_query("SELECT * FROM dress WHERE Nama_Dress LIKE '%$skypencarian%' ");
$skyqueryjeans = mysql_query("SELECT * FROM jeans WHERE Nama_Jeans LIKE '%$skypencarian%' ");
$skyquerykemeja = mysql_query("SELECT * FROM kemeja WHERE Nama_Kemeja LIKE '%$skypencarian%' ");
$skyquerymuslim = mysql_query("SELECT * FROM muslim WHERE Nama_Muslim LIKE '%$skypencarian%' ");
$skyqueryrok = mysql_query("SELECT * FROM rok WHERE Nama_Rok LIKE '%$skypencarian%' ");
$skyquerytshirt = mysql_query("SELECT * FROM tshirt WHERE Nama_Tshirt LIKE '%$skypencarian%' ");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="content">
            ...
            <?php echo "<a href='Form_DetailTshirt_Highlight.php?IDT=".$skyrowtshirt['ID_Tshirt']."'>";?>
            <img src="../uploaded/<?php echo $skyrowtshirt['Gambar_Tshirt'];?>" width="100px" height="100px">
            <?php echo $skyrowtshirt['Nama_Tshirt'] ;?>&nbsp;&nbsp;
            <?php } ?>
            <?php echo"</a>";?>
            <?php tshirt_hilang();?>
            </div>
            ...
            <?php echo "<a href='Form_DetailDress_Highlight.php?IDD=".$skyrowdress['ID_Dress']."'>";?>
            <img src="../uploaded/<?php echo $skyrowdress['Gambar_Dress'];?>" width="100px" height="100px">
            <?php echo $skyrowdress['Nama_Dress'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php dress_hilang() ;?>
            </div>
            ...
            <?php echo "<a href='Form_DetailRok_Highlight.php?IDR=".$skyrowrok['ID_Rok']."'>";?>
            <img src="../uploaded/<?php echo $skyrowrok['Gambar_Rok'];?>" width="100px" height="100px">
            <?php echo $skyrowrok['Nama_Rok'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php rok_hilang() ;?>
            </div>
            ...
            <?php echo "<a href='Form_DetailJeans_Highlight.php?IDJ=".$skyrowjeans['ID_Jeans']."'>";?>
            <img src="../uploaded/<?php echo $skyrowjeans['Gambar_Jeans'];?>" width="100px" height="100px">
            <?php echo $skyrowjeans['Nama_Jeans'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php jeans_hilang(); ?>
            </div>
            ...
            <?php echo "<a href='Form_DetailBaby_Highlight.php?IDB=".$skyrowbaby['ID_Baby']."'>";?>
            <img src="../uploaded/<?php echo $skyrowbaby['Gambar_Baby'];?>" width="100px" height="100px">
            <?php echo $skyrowbaby['Nama_Baby'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php baby_hilang(); ?>
            </div>
            ...
            <?php echo "<a href='Form_DetailMuslim_Highlight.php?IDM=".$skyrowmuslim['ID_Muslim']."'>";?>
            <img src="../uploaded/<?php echo $skyrowmuslim['Gambar_Muslim'];?>" width="100px" height="100px">
            <?php echo $skyrowmuslim['Nama_Muslim'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php muslim_hilang(); ?>
            </div>
            ...
            <?php echo "<a href='Form_DetailKemeja_Highlight.php?IDK=".$skyrowkemeja['ID_Kemeja']."'>";?>
            <img src="../uploaded/<?php echo $skyrowkemeja['Gambar_Kemeja'];?>" width="100px" height="100px">
            <?php echo $skyrowkemeja['Nama_Kemeja'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php kemeja_hilang(); ?>
            </div>
            ...
            <?php echo "<a href='Form_DetailBlezer_Highlight.php?IDBL=".$skyrowblezer['ID_Blezer']."'>";?>
            <img src="../uploaded/<?php echo $skyrowblezer['Gambar_Blezer'];?>" width="100px" height="100px">
            <?php echo $skyrowblezer['Nama_Blezer'] ;?>&nbsp;&nbsp;
            <?php } ?><?php echo"</a>";?>
            <?php blezer_hilang(); ?>
            </div>
</div>
