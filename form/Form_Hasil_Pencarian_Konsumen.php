...
$skyquerytshirt = mysql_query("SELECT * FROM produk WHERE Nama_Produk LIKE '%$skypencarian%'");
$skyt = 0;
    $jml    = mysql_num_rows($skyquerytshirt)
?>
<!DOCTYPE HTML>
<html lang="en">
    <head>
    ...
    if($jml  > 0){
                    while($skyrowtshirt = mysql_fetch_array($skyquerytshirt)){
                    ?>
                    <div class="show-cari" id="show" onclick="hover()">
