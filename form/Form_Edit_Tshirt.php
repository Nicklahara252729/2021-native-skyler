...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Tshirt.php" method="post" enctype="multipart/form-data">
            ...
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Tshirt'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
