...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            Gambar Produk : <img src="../uploaded/<?php echo $skyrow['Gambar_Produk'] ;?>" width="100px" height="100px"><br>
            ...
            Harga : <?php echo"Rp.";echo number_format($skyrow['Harga']);?><br>
            <?php echo "<a href='Form_Pemesanan_Konsumen.php?ID=".$skyrow['ID_Produk']."'> Pesan" ;?><br>
            <?php echo "<a href='../Proses/Proses_Input_Keranjang_Konsumen.php?Input=Add&ID=".$skyrow['ID_Produk']."&Nama=".$skyrow['Nama_Produk']."&Harga=".$skyrow['Harga']."&Supp=".$skyrow['Supplier']."'> Tambahkan Ke Keranjang";?><br>
