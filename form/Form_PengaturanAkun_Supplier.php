...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            Nama Lengkap = <?php echo $skyrow['Nama_Lengkap'] ;?><br>
            Alamat = <?php echo $skyrow['Alamat'] ;?><br>
            Kode Pos = <?php echo $skyrow['Kode_Pos'] ;?><br>
            Email = <?php echo $skyrow['Email'] ;?><br>
            Username = <font name="IDU"><?php echo $skyrow['Username'] ;?></font><br>
            Password = <?php echo $skyrow['Password'] ;?><br>
            <?php echo "<a href='Form_Edit_AkunSupplier.php?IDU=".$skyrow['ID']."'> Edit Info Akun";?><br>
