...
$skyquery = mysql_query("SELECT * FROM user_supplier WHERE Username='$akun'");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            Nama Lengkap = <?php echo $skyrow['Nama_Supplier'] ;?><br>
            ...
            <?php echo "<a href='Form_Edit_AkunSupplier.php?ID=".$skyrow['ID_Supplier']."'> Edit Info Akun";?><br>
