...
$id = $_GET['IDU'];
$skyquery = mysql_query("SELECT * FROM user_supplier WHERE ID='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_AkunSupplier.php" method="post" enctype="multipart/form-data">
            Edit Info Akun<br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID'] ;?>" style="visibility:hidden;"><br>
            Nama Lengkap = <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Lengkap'] ;?>"><br>
            Alamat = <input type="text" name="Alamat" value="<?php echo $skyrow['Alamat'] ;?>"><br>
            Kode Pos = <input type="text" name="Kodepos" value="<?php echo $skyrow['Kode_Pos'] ;?>"><br>
            ...
            <a href="Form_PengaturanAkun_Supplier.php">Kembali</a>
</div>
        <footer>
