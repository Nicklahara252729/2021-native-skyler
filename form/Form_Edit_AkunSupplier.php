...
$id = $_GET['ID'];
$skyquery = mysql_query("SELECT * FROM user_supplier WHERE ID_Supplier='$id' ");
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_AkunSupplier.php" method="post" enctype="multipart/form-data">
            Edit Info Akun<br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Supplier'] ;?>" style="visibility:hidden;"><br>
            Nama Lengkap = <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Supplier'] ;?>"><br>
