...
$id = $_GET['IDM'];
$skyquery = mysql_query("SELECT * FROM muslim WHERE ID_Muslim='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Muslim.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Muslim'] ;?>" style="visibility:hidden;"><br>
            Nama Baju Muslim <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Muslim'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Muslim'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
