...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Kemeja.php" method="post" enctype="multipart/form-data">
            Tambah Baju Kemeja Baru<br><br><br>
            Nama Baju Kemeja <input type="text" name="Nama" required><br>
            Gambar Baju Kemeja <input type="file" name="file" required>
