...
$id = $_GET['IDBL'];
$skyquery = mysql_query("SELECT * FROM blezer WHERE ID_Blezer='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Blezer.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Blezer'] ;?>" style="visibility:hidden;"><br>
            Nama Blezer <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Blezer'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Blezer'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
