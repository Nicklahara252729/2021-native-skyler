...
<html lang="en">
    ...
    <body>
        ...
        <div class="subheader" id="sb">
            ...
            <form action="Form_Hasil_Pencarian_Suplier.php" method="post">
                <select name="">
                    <?php
        ...
        <div class="content-pengaturan-barang-supplier">
            Gambar Barang : <img src="../uploaded/<?php echo $skyrow['Gambar_Dress'] ;?>" width="100px" height="100px"><br>
            Nama Dress : <?php echo $skyrow['Nama_Dress'];?><br>
            ...
            <a href="Form_NewBrand_Supplier.php">Kembali</a>
</div>
        <footer>
