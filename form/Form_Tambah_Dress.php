...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Dress.php" method="post" enctype="multipart/form-data">
            Tambah Dress Baru<br><br><br>
            Nama Dress <input type="text" name="Nama" required><br>
            Gambar Dress <input type="file" name="file" required>
