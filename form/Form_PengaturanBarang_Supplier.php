...
$skyquerytshirt = mysql_query("SELECT * FROM tshirt WHERE Supplier='$skyakun'");
$skyquerydress = mysql_query("SELECT * FROM dress WHERE Supplier='$skyakun'");
$skyqueryrok = mysql_query("SELECT * FROM rok WHERE Supplier='$skyakun'");
$skyqueryjeans = mysql_query("SELECT * FROM jeans WHERE Supplier='$skyakun'");
$skyquerybaby = mysql_query("SELECT * FROM baby WHERE Supplier='$skyakun'");
$skyquerymuslim = mysql_query("SELECT * FROM muslim WHERE Supplier='$skyakun'");
$skyquerykemeja = mysql_query("SELECT * FROM kemeja WHERE Supplier='$skyakun'");
$skyqueryblezer = mysql_query("SELECT * FROM blezer WHERE Supplier='$skyakun'");
$skyt = 0;
$skyd = 0;
$skyr = 0;
$skyj = 0;
    ...
    <body>
        ...
        <header>
            ...
            <div class="promo">
               <form action="#" method="post">
                    <input type="text" name="" placeholder="Cari Pakaian, atau merk">
        ...
        <div class="bawah">
            <div class="sub-bawah">
                <ul>
                    ...
                    <a href="Form_Keranjang.php"><li><span class="glyphicon glyphicon-shopping-cart"></span></li></a>
        ...
        <div class="subheader" id="sb">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="" placeholder="Cari Pakaian, atau merk" required>
                <button type="submit"><span class="glyphicon glyphicon-search"></span></button>
            </form>
            <div class="shop">
        ...
        <div class="content-pengaturan-barang-supplier">
            ...
            <?php echo $skyt+1 ;?>. <?php echo $skyrowtshirt['Nama_Tshirt'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Tshirt.php?IDT=".$skyrowtshirt['ID_Tshirt']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Tshirt.php?IDT=".$skyrowtshirt['ID_Tshirt']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Tshirt.php?IDT=".$skyrowtshirt['ID_Tshirt']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyt++; } ?>
            ...
            <?php echo $skyd+1 ;?>. <?php echo $skyrowdress['Nama_Dress'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Dress.php?IDD=".$skyrowdress['ID_Dress']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Dress.php?IDD=".$skyrowdress['ID_Dress']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Dress.php?IDD=".$skyrowdress['ID_Dress']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyd++; } ?>
            ...
            <?php echo $skyr+1 ;?>. <?php echo $skyrowrok['Nama_Rok'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Rok.php?IDR=".$skyrowrok['ID_Rok']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Rok.php?IDR=".$skyrowrok['ID_Rok']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Rok.php?IDR=".$skyrowrok['ID_Rok']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyr++; } ?>
            ...
            <?php echo $skyj+1 ;?>. <?php echo $skyrowjeans['Nama_Jeans'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Jeans.php?IDJ=".$skyrowjeans['ID_Jeans']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Jeans.php?IDJ=".$skyrowjeans['ID_Jeans']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Jeans.php?IDJ=".$skyrowjeans['ID_Jeans']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyj++; } ?>
            ...
            <?php echo $skyb+1 ;?>. <?php echo $skyrowbaby['Nama_Baby'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Baby.php?IDB=".$skyrowbaby['ID_Baby']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Baby.php?IDB=".$skyrowbaby['ID_Baby']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Baby.php?IDB=".$skyrowbaby['ID_Baby']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyb++; } ?>
            ...
            <?php echo $skym+1 ;?>. <?php echo $skyrowmuslim['Nama_Muslim'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Muslim.php?IDM=".$skyrowmuslim['ID_Muslim']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Muslim.php?IDM=".$skyrowmuslim['ID_Muslim']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Muslim.php?IDM=".$skyrowmuslim['ID_Muslim']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skym++; } ?>
            ...
            <?php echo $skyk+1 ;?>. <?php echo $skyrowkemeja['Nama_Kemeja'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Kemeja.php?IDK=".$skyrowkemeja['ID_Kemeja']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Kemeja.php?IDK=".$skyrowkemeja['ID_Kemeja']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Kemeja.php?IDK=".$skyrowkemeja['ID_Kemeja']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skyk++; } ?>
            ...
            <?php echo $skybl+1 ;?>. <?php echo $skyrowblezer['Nama_Blezer'] ;?> &nbsp; 
            <?php echo "<a href='Form_Detail_Blezer.php?IDBL=".$skyrowblezer['ID_Blezer']."'> Detail";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='Form_Edit_Blezer.php?IDBL=".$skyrowblezer['ID_Blezer']."'> Edit";?>
            <?php echo"</a>"; ?> &nbsp; 
            <?php echo "<a href='../proses/Proses_Delete_Blezer.php?IDBL=".$skyrowblezer['ID_Blezer']."'> Delete";?>
            <?php echo"</a>"; ?> <br>
            <?php $skybl++; } ?>
