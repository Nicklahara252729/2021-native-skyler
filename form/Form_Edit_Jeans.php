...
$id = $_GET['IDJ'];
$skyquery = mysql_query("SELECT * FROM jeans WHERE ID_Jeans='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Jeans.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Jeans'] ;?>" style="visibility:hidden;"><br>
            Nama Jeans <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Jeans'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Jeans'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
