...
<html lang="en">
    ...
    <body>
        ...
        <div class="pengaturan-supplier">
            ...
            <ul>
                <li class="pengaturan-akun"> <span class="glyphicon glyphicon-log-in"></span> &nbsp; <a href="Form_PengaturanAkun_Supplier.php">engaturan Akun</a></li>
        ...
        <div class="content-pengaturan-barang-supplier">
            Gambar Barang : <img src="../uploaded/<?php echo $skyrow['Gambar_Kemeja'] ;?>" width="100px" height="100px"><br>
            Nama Kemeja : <?php echo $skyrow['Nama_Kemeja'];?><br>
