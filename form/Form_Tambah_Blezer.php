...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Blezer.php" method="post" enctype="multipart/form-data">
            Tambah Blezer Baru<br><br><br>
            Nama Blezer <input type="text" name="Nama" required><br>
            Gambar Blezer <input type="file" name="file" required>
