...
$id = $_GET['IDB'];
$skyquery = mysql_query("SELECT * FROM baby WHERE ID_Baby='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Baby.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Baby'] ;?>" style="visibility:hidden;"><br>
            Nama Baju Baby <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Baby'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Baby'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
