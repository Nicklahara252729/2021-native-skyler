...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <input type="text" value="<?php $skyrow['ID_Tshirt'] ;?>" style="visibility:hidden;"><br>
            Gambar Barang : <img src="../uploaded/<?php echo $skyrow['Gambar_Tshirt'] ;?>" width="100px" height="100px"><br>
            Nama Tshirt : <?php echo $skyrow['Nama_Tshirt'];?><br>
            Ukuran : <?php echo $skyrow['Ukuran'];?><br>
            Warna : <?php echo $skyrow['Warna'];?><br>
            Stock : <?php echo $skyrow['Stok'];?> Unit<br>
            Harga : <?php echo $skyrow['Harga'];?><br>
            <?php echo "<a href='Form_Pemesanan.php?IDT=".$skyrow['ID_Tshirt']."'> Pesan"; ?>
            <?php echo "</a>";?><br>
            <?php echo "<a href='../Proses/Proses_Input_Keranjang.php?Input=Add&IDT=".$skyrow['ID_Tshirt']."&Nama=".$skyrow['Nama_Tshirt']."&Harga=".$skyrow['Harga']."'> Tambahkan Ke Keranjang";?><br>
            <a href="Form_Supplier.php">Kembali</a><br> 
</div>
        <footer>
