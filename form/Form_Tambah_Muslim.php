...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Muslim.php" method="post" enctype="multipart/form-data">
            Tambah Baju Muslim Baru<br><br><br>
            Nama Baju Muslim <input type="text" name="Nama" required><br>
            Gambar Baju Muslim <input type="file" name="file" required>
