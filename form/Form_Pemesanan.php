...
include "../proses/koneksi.php";
$skyid = $_GET['IDT'];
$skyquerytshirt = mysql_query("SELECT * FROM tshirt WHERE ID_Tshirt='$skyid'");
$skyrow = mysql_fetch_array($skyquerytshirt);
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="content-pesanan">
            Nama Barang : <?php echo $skyrow['Nama_Tshirt'] ;?><br>
            Gambar Barang : 
            <img src="../uploaded/<?php echo $skyrow['Gambar_Tshirt'] ;?>" width="200px" height="200px">
            <br>
            Jumlah Pembelian : <input type="text" name=""><br>
            Harga Satuan : <?php echo $skyrow['Harga'] ;?> <br>
