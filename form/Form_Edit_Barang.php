...
$id = $_GET['ID'];
$skyquery = mysql_query("SELECT * FROM tshirt WHERE ID_Tshirt='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <header>
            <div class="atas">
                ...
                <ul>
                    ...
                    <li class="li-registrasi">Supplier Aktif : <?php echo $_SESSION['user'] ;?><span class="glyphicon glyphicon-user"></span>                        
                    </li>
        ...
        <div class="pengaturan-supplier">
            ...
            <ul>
                <li class="pengaturan-akun"> <span class="glyphicon glyphicon-log-in"></span> &nbsp; Pengaturan Akun</li>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Barang.php" method="post">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Tshirt'] ;?>" style="visibility:hidden;"><br>
            Nama T-Shirt <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Tshirt'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Tshirt'];?>" width="100px" height="100px"><input type="file" name="file"><br>
            Ukuran <input type="text" name="Ukuran" value="<?php echo $skyrow['Ukuran'] ;?>" required><br>
            Warna <input type="text" name="Warna" value="<?php echo $skyrow['Warna'] ;?>" required><br>
            Stock <input type="text" name="Stock" value="<?php echo $skyrow['Stok'] ;?>" required><br>
            Harga <input type="text" name="Harga" value="<?php echo $skyrow['Harga'] ;?>" required><br>
            <input type="submit" value="Edit Info" name="submit">
            </form><br>
            <a href="Form_PengaturanBarang_Supplier.php">Kembali</a>
</div>
        <footer>
