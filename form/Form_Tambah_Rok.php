...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Rok.php" method="post" enctype="multipart/form-data">
            Tambah Rok Baru<br><br><br>
            Nama Rok <input type="text" name="Nama" required><br>
            Gambar Rok <input type="file" name="file" required>
