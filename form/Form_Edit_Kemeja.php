...
$id = $_GET['IDK'];
$skyquery = mysql_query("SELECT * FROM kemeja WHERE ID_Kemeja='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Kemeja.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Kemeja'] ;?>" style="visibility:hidden;"><br>
            Nama Baju Kemeja <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Kemeja'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Kemeja'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
