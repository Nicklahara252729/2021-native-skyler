...
$skyquerybaby = mysql_query("SELECT * FROM produk WHERE Kategori='Baby' ORDER BY ID_Produk DESC");
$skyqueryblezer = mysql_query("SELECT * FROM produk WHERE Kategori='Blezer' ORDER BY ID_Produk DESC");
$skyquerydress = mysql_query("SELECT * FROM produk WHERE Kategori='Dress' ORDER BY ID_Produk DESC");
$skyqueryjeans = mysql_query("SELECT * FROM produk WHERE Kategori='Jeans' ORDER BY ID_Produk DESC");
$skyquerykemeja = mysql_query("SELECT * FROM produk WHERE Kategori='Kemeja' ORDER BY ID_Produk DESC");
$skyquerymuslim = mysql_query("SELECT * FROM produk WHERE Kategori='Muslim' ORDER BY ID_Produk DESC");
$skyqueryrok = mysql_query("SELECT * FROM produk WHERE Kategori='Rok' ORDER BY ID_Produk DESC");
$skyquerytshirt = mysql_query("SELECT * FROM produk WHERE Kategori='Tshirt' ORDER BY ID_Produk DESC");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="content">
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowtshirt['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowdress['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowrok['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowjeans['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowbaby['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowmuslim['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowkemeja['ID_Produk']."'>";?>
            ...
            <?php echo "<a href='Form_Detail_Produk_Konsumen.php?ID=".$skyrowblezer['ID_Produk']."'>";?>
