...
<?php
session_start();
if (isset ($_SESSION['user_supplier']) or ($_SESSION['user_konsumen'])) {
?>
<?php 
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            Gambar Baju Baby : <img src="../uploaded/<?php echo $skyrow['Gambar_Baby'] ;?>" width="100px" height="100px"><br>
            Nama Baju Baby : <?php echo $skyrow['Nama_Baby'];?><br>
