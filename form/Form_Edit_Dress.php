...
$id = $_GET['IDD'];
$skyquery = mysql_query("SELECT * FROM dress WHERE ID_Dress='$id' ");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
           <form action="../proses/Proses_Edit_Dress.php" method="post" enctype="multipart/form-data">
            Edit Info Barang<br><br>
            <input type="text" name="ID" value="<?php echo $skyrow['ID_Dress'] ;?>" style="visibility:hidden;"><br>
            Nama Dress <input type="text" name="Nama" value="<?php echo $skyrow['Nama_Dress'] ;?>" required><br>
            Gambar Barang <img src="../uploaded/<?php echo $skyrow['Gambar_Dress'];?>" width="100px" height="100px"><input type="file" name="file" required><br>
