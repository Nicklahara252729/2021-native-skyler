...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Baby.php" method="post" enctype="multipart/form-data">
            Tambah Baju Baby Baru<br><br><br>
            Nama Baju Baby <input type="text" name="Nama" required><br>
            Gambar Baju Baby <input type="file" name="file" required>
