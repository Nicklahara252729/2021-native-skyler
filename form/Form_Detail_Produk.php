...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            ...
            <a href="Form_Pemesanan_Supplier.php">Pesan</a><br>
            <?php echo "<a href='../Proses/Proses_Input_Keranjang.php?Input=Add&ID=".$skyrow['ID_Produk']."&Nama=".$skyrow['Nama_Produk']."&Harga=".$skyrow['Harga']."'> Tambahkan Ke Keranjang";?><br>
