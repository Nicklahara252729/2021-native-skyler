...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Tshirt.php" method="post" enctype="multipart/form-data">
            Tambah T-Shirt Baru<br><br><br>
            Nama T-Shirt <input type="text" name="Nama" required><br>
            Gambar Barang <input type="file" name="file" required>
