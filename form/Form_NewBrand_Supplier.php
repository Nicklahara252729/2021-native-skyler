...
$skyquerybaby = mysql_query("SELECT * FROM baby ORDER BY ID_Baby DESC");
$skyqueryblezer = mysql_query("SELECT * FROM blezer ORDER BY ID_Blezer DESC");
$skyquerydress = mysql_query("SELECT * FROM dress ORDER BY ID_Dress DESC");
$skyqueryjeans = mysql_query("SELECT * FROM jeans ORDER BY ID_Jeans DESC");
$skyquerykemeja = mysql_query("SELECT * FROM kemeja ORDER BY ID_Kemeja DESC");
$skyquerymuslim = mysql_query("SELECT * FROM muslim ORDER BY ID_Muslim DESC");
$skyqueryrok = mysql_query("SELECT * FROM rok ORDER BY ID_Rok DESC");
$skyquerytshirt = mysql_query("SELECT * FROM tshirt ORDER BY ID_Tshirt DESC");
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <font size="7">New Brand From All Category</font>
        ...
        <div class="content">
            ...
            <?php echo "<a href='Form_DetailTshirt_NewBrand.php?IDT=".$skyrowtshirt['ID_Tshirt']."'>";?>
            ...
            <?php echo "<a href='Form_DetailDress_NewBrand.php?IDD=".$skyrowdress['ID_Dress']."'>";?>
            ...
            <?php echo "<a href='Form_DetailRok_NewBrand.php?IDR=".$skyrowrok['ID_Rok']."'>";?>
            ...
            <?php echo "<a href='Form_DetailJeans_NewBrand.php?IDJ=".$skyrowjeans['ID_Jeans']."'>";?>
            ...
            <?php echo "<a href='Form_DetailBaby_NewBrand.php?IDB=".$skyrowbaby['ID_Baby']."'>";?>
            ...
            <?php echo "<a href='Form_DetailMuslim_NewBrand.php?IDM=".$skyrowmuslim['ID_Muslim']."'>";?>
            ...
            <?php echo "<a href='Form_DetailKemeja_NewBrand.php?IDK=".$skyrowkemeja['ID_Kemeja']."'>";?>
            ...
            <?php echo "<a href='Form_DetailBlezer_NewBrand.php?IDBL=".$skyrowblezer['ID_Blezer']."'>";?>
