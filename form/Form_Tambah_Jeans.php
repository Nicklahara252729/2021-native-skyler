...
<html lang="en">
    ...
    <body>
        ...
        <div class="content-pengaturan-barang-supplier">
            <form action="../Proses/Proses_Tambah_Jeans.php" method="post" enctype="multipart/form-data">
            Tambah Jeans Baru<br><br><br>
            Nama Jeans <input type="text" name="Nama" required><br>
            Gambar Jeans <input type="file" name="file" required>
