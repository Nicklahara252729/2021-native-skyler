...
$skyquery = mysql_query("SELECT * FROM user_konsumen");
$rnpdata = mysql_fetch_array($skyquery);
if (isset ($_SESSION['user_konsumen']) && ($rnpdata['Jenis'] == 'Pembeli')) {
?>
<?php 
include "../proses/koneksi.php";
$skyid = $_GET['ID'];
...
<html lang="en">
    ...
    <body>
        ...
        <div class="bawah">
            <div class="sub-bawah">
                <ul>
                    ...
                    ?>
                    <a href="Form_Keranjang_Konsumen.php"><li><span class="glyphicon glyphicon-shopping-cart"></span><?php echo $skyjum ;?></li></a>
        ...
        <div class="content-pesanan">
            <?php echo "<form action='../proses/Proses_Transaksi.php?Supp=".$skyrow['Supplier']."&ID=".$skyrow['ID_Produk']."' method='post'>";?>
            Nama Produk : <input readonly type="text" name="Produk" value="<?php echo $skyrow['Nama_Produk']; ?>"><br>
            Gambar Barang : <img src="../uploaded/<?php echo $skyrow['Gambar_Produk'] ;?>" width="200px" height="200px"><br>
            ...
            No HP Yg Bisa Dihubungi : <input type="text" name="HP" required><br>
            <input type="submit" value="Pesan"><?php echo "</form>";?><br>
...
<a href="Form_Konsumen.php">Back</a>
</p>
<?php
}
?>