...
<html lang="en">
    ...
    <body>
        ...
        $skyquery = mysql_query("SELECT * FROM transaksi WHERE Pembeli='$skypembeli' "); 
        $skyj = 0;
        ;?>
            Barang Yang Dipesan<br><br>
            ...
            <th style="padding-left: 5px;">Status</td>
            </tr>
            <?php while ($skyrow = mysql_fetch_array($skyquery)) {;?>
            <tr>
