<?php
session_start();
$skydes = session_destroy();
$skyses = session_id();
include "proses/koneksi.php";
if (isset($skydes)){
mysql_query("DELETE FROM cart WHERE ID_Session='$skyses'");
}; ?>
<!DOCTYPE HTML>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="regis-penjual">
            <div class="formulir-penjual">
                ...
                <form action="proses/Proses_Daftar_Supplier.php" method="post">
            ...
            <div class="readme-penjual">
                <img src="img/logo-sponsor/laz01.png">
        ...
        <div class="regis-pembeli">
            <div class="formulir-pembeli">
                ...
                <form action="proses/Proses_Daftar_Konsumen.php" method="post">
                        <input type="text" name="nama" placeholder="Nama Lengkap" required>
                        <input type="text" name="jenkel" placeholder="Jenis Kelamin" required>
                ...
                <p>
                    <ul>
                        <li class="ketentuan-buyer">Ketentuan Pembeli &nbsp;</li>
                        <li> | </li>
                        <li class="kebijakan-buyer">&nbsp;Kebijakan pembeli</li>
                </ul>
                </p>
            </div>
    <div class="readme-penjual">
                <img src="img/logo-sponsor/laz01.png">
                <div class="ketentuan-pembeli">
                    <p>ketentuan ketentuan ketentuanketentuan ketentuan ketentuanketentuanketentuanketentuanketentuanketentuan  ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuanketentuanketentuanketentuanketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuanketentuan ketentuan ketentuanketentuanketentuanketentuanketentuanketentuan  ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuanketentuanketentuanketentuanketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuanketentuan ketentuan ketentuanketentuanketentuanketentuanketentuanketentuan  ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuanketentuanketentuanketentuanketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan ketentuan</p>
        </div>
                <div class="kebijakan-pembeli"></div>
            </div>
        </div>
        <div class="login-penjual">
            <div class="readme-login-pembeli">
        ...
        <div class="login-pembeli">
            <div class="readme-login-pembeli">
               <img src="img/logo-sponsor/skyler%20apps%20buyer.png" id="img1">
               <img src="img/logo-sponsor/skyler%20apps%20buyer%202.png" id="img2">
            </div>
            <div class="forms-login-pembeli">
                <div class="minitron-login">
                <img src="img/logo-sponsor/logoputih.png">
        ...
        <div class="content">
            <div class="isi-content" id="content-tshirt"></div>
            <div class="isi-content" id="content-dress"></div>
            <div class="isi-content" id="content-rok"></div>
            <div class="isi-content" id="content-jeans"></div>
            <div class="isi-content" id="content-baby"></div>
            <div class="isi-content" id="content-muslim"></div>
            <div class="isi-content" id="content-kemeja"></div>
            <div class="isi-content" id="content-blezer"></div>
</div>
